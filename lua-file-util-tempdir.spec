%define luarocks_pkg_name file-util-tempdir
%define luarocks_pkg_version 0.0.1-1
%define luarocks_pkg_prefix file-util-tempdir-0.0.1-1
...
Url: https://github.com/huakim/lua-file-util-tempdir
License: LGPL
Provides: %{luadist %{luarocks_pkg_name} = %{luarocks_pkg_version}}
Requires: %{luadist lua >= 5.1}
Requires: %{luadist get_os_name}

Source0: file-util-tempdir-0.0.1-1.tar.gz
Source1: file-util-tempdir-0.0.1-1.rockspec
